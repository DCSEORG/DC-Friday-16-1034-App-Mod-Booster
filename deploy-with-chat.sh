...
echo "🚀 Deploying infrastructure (App Service + Azure SQL + Azure OpenAI + AI Search)..."
...
echo "💬 AI Chat UI available at: /Chat (fully functional with Azure OpenAI)"
echo ""
echo "🤖 GenAI Features:"
echo "  - Natural language expense queries"
echo "  - Create expenses via chat"
echo "  - Function calling for database operations"
echo "  - RAG-enabled responses"
echo ""
